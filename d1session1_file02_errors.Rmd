---
title: "Day 1 - File 2 - ignore errors"
...
knitr::opts_chunk$set(error = TRUE) # still compile with errors
```
...
Let's get some summary statistics using the `summary()` function. The summary function will give us the mean, median, min and max and IQR for numerical data. _All that is missing is the standard deviation._
...
Let's do this again - the dplyr way - using mutate()
